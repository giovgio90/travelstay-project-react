...
import { addReviewThree, setUser, updateOffer } from "../redux/actions";
import { Scrollbar } from "react-scrollbars-custom";

import FooterTravelStay from "./FooterTravelStay";
import Rating from "react-rating";
import ReservationFormFour from "./ReservationForm.Four";
        ...
        <Container>
          ...
          <Row>
            <Col md={8} className="mt-4">
              ...
              <Card>
                {/* <Card.Img src={tour.images[0]} alt={tour.name} /> */}
                ...
                <Card.Body>
                  ...
                  <Card.Text>Descrizione: {tour.description}</Card.Text>
                  <Image src={tour.images[0]} className="w-50" />
                  <Card.Text>Prezzo adulti: {tour.price}€</Card.Text>
                  <Card.Text>Prezzo bambini: {tour.price_per_child}€</Card.Text>

                  <Card.Text>Tappe: {tour.highlights.join(", ")}</Card.Text>
                </Card.Body>
              </Card>
            </Col>
